#!/bin/bash
#$ -N fd_005_02_01_rnaseq_2017_04_28_full_rnaseq-16.06
#$ -q long-sl7
#$ -l virtual_free=60G
#$ -l h_rt=24:00:00
#$ -o /users/GR/mb/jquilez/projects/conseq/scripts/pipelines/rnaseq-16.06/job_out/fd_005_02_01_rnaseq_2017_04_28_full_rnaseq-16.06_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/projects/conseq/scripts/pipelines/rnaseq-16.06/job_out/fd_005_02_01_rnaseq_2017_04_28_full_rnaseq-16.06_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 8

submitted_on=2017_04_28
pipeline_version=16.06
sample_id=fd_005_02_01_rnaseq
data_type=rnaseq
pipeline_name=rnaseq
pipeline_version=16.06
pipeline_run_mode=full
io_mode=standard
CUSTOM_IN=scripts/pipelines/rnaseq-16.06/test
CUSTOM_OUT=scripts/pipelines/rnaseq-16.06/test
...
strand_specific=2
CUSTOM_OUT=scripts/pipelines/rnaseq-16.06/test
PIPELINE=/users/GR/mb/jquilez/projects/conseq/scripts/pipelines/rnaseq-16.06
config=scripts/pipelines/rnaseq-16.06/rnaseq.config
path_job_file=/users/GR/mb/jquilez/projects/conseq/scripts/pipelines/rnaseq-16.06/job_cmd/fd_005_02_01_rnaseq_2017_04_28_full_rnaseq-16.06.sh
time_start=$(date +"%s")
