#!/bin/bash
#$ -N fd_005_01_01_rnaseq_2017_04_28_full_rnaseq-16.06
#$ -q long-sl7
#$ -l virtual_free=60G
#$ -l h_rt=24:00:00
#$ -o /users/GR/mb/jquilez/projects/conseq/scripts/pipelines/rnaseq-16.06/job_out/fd_005_01_01_rnaseq_2017_04_28_full_rnaseq-16.06_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/projects/conseq/scripts/pipelines/rnaseq-16.06/job_out/fd_005_01_01_rnaseq_2017_04_28_full_rnaseq-16.06_$JOB_ID.err
#$ -j y
...
path_job_file=/users/GR/mb/jquilez/projects/conseq/scripts/pipelines/rnaseq-16.06/job_cmd/fd_005_01_01_rnaseq_2017_04_28_full_rnaseq-16.06.sh
time_start=$(date +"%s")
