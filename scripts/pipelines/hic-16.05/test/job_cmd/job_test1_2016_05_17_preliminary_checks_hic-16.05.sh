#!/bin/bash
#$ -N job_test1_2016_05_17_preliminary_checks_hic-16.05
#$ -q short-sl65
#$ -l virtual_free=40G
#$ -l h_rt=6:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.05/test/job_out/job_test1_2016_05_17_preliminary_checks_hic-16.05_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.05/test/job_out/job_test1_2016_05_17_preliminary_checks_hic-16.05_$JOB_ID.err
#$ -j y
...
pipeline_name=hic
pipeline_version=16.05
pipeline_run_mode=preliminary_checks
io_mode=custom
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.05/test/job_cmd/job_test1_2016_05_17_preliminary_checks_hic-16.05.sh
