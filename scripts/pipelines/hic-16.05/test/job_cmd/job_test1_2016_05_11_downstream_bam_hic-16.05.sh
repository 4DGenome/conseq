#!/bin/bash
#$ -N job_test1_2016_05_11_downstream_bam_hic-16.05
#$ -q short-sl65
#$ -l virtual_free=20G
#$ -l h_rt=06:00:00
#$ -o /users/project/4DGenome/pipelines/hic-16.05/test/job_out/job_test1_2016_05_11_downstream_bam_hic-16.05_$JOB_ID.out
#$ -e /users/project/4DGenome/pipelines/hic-16.05/test/job_out/job_test1_2016_05_11_downstream_bam_hic-16.05_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 1

submitted_on=2016_05_11
pipeline_version=16.05
sample_id=test1
data_type=hic
pipeline_name=hic
pipeline_version=16.05
pipeline_run_mode=downstream_bam
io_mode=custom
...
path_job_file=/users/project/4DGenome/pipelines/hic-16.05/test/job_cmd/job_test1_2016_05_11_downstream_bam_hic-16.05.sh
