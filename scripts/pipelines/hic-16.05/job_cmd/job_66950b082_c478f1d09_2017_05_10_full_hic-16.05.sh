#!/bin/bash
#$ -N job_66950b082_c478f1d09_2017_05_10_full_hic-16.05
#$ -q long-sl7
#$ -l virtual_free=100G
#$ -l h_rt=100:00:00
#$ -o /users/GR/mb/jquilez/projects/conseq/scripts/pipelines/hic-16.05/job_out/job_66950b082_c478f1d09_2017_05_10_full_hic-16.05_$JOB_ID.out
#$ -e /users/GR/mb/jquilez/projects/conseq/scripts/pipelines/hic-16.05/job_out/job_66950b082_c478f1d09_2017_05_10_full_hic-16.05_$JOB_ID.err
#$ -j y
#$ -M javier.quilez@crg.eu
#$ -m abe
#$ -pe smp 10

submitted_on=2017_05_10
...
path_job_file=/users/GR/mb/jquilez/projects/conseq/scripts/pipelines/hic-16.05/job_cmd/job_66950b082_c478f1d09_2017_05_10_full_hic-16.05.sh
